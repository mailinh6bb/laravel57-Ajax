                ...
                <div class="col-lg-5 col-md-8 single-right-left ">
                    <div class="grid images_3_of_2">
                        <div class="flexslider">
                         <ul class="slides">
                            <li data-thumb="{{ asset('upload/image_product/file/'.$product-> avatar) }}">
                                <div class="thumb-image">
                                    <img src="{{asset('upload/image_product/file/'.$product -> avatar)}}" data-imagezoom="true" class="img-fluid" alt="">
                                </div>
                            </li>
                            <li data-thumb="{{asset('upload/image_product/file/'.$product -> avatar)}}">
                                <div class="thumb-image">
                            ...
                            <li data-thumb="{{asset('upload/image_product/file/'.$product -> avatar)}}">
                                <div class="thumb-image">
                                    <img src="{{asset('upload/image_product/file/'.$product -> avatar)}}" data-imagezoom="" class="img-fluid" alt="">
                                </div>
                            </li>
                        </ul>
