...
<div class="privacy py-sm-5 py-4">
	<div class="container py-xl-4 py-lg-2">
		...
		<div class="checkout-right">
			<h4 class="mb-sm-4 mb-3">Sản Phẩm Đã Mua:
					...
					<tbody>
						...
						<tr class="rem1">
							...
							<td class="invert-image">
								<a href="#">
									<img src="{{asset('upload/image_product/file/'.$value->options->avatar) }}" height="100" alt="{{ $value->name }}" class="img-responsive">
								</a>
							</td>
							...
							<td class="invert">
								<div class="quantity">
									<div class="form-group">
										...
										<input type="hidden" name="" class="pro_id{{$value -> rowId}}" value="{{$value -> id}}">
									</div>
								</div>
							</td>
							<td>{{$value ->options->sale}}%</td>
		...
		<div class="checkout-left">
			<div class="address_form_agile mt-sm-5 mt-4">
				<a href="" class="submit check_out btn">Giao hàng đến địa chỉ này</a>
				<div class="checkout-right-basket">
					<a href="{{ route('checkout') }}">Chọn phương thức thanh toán
