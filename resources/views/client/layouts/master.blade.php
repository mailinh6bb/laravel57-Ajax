...
<head>
	<title>Shop Thời Trang- @yield('title') </title>
	<!-- Meta tag Keywords -->
	...
	<!-- Custom-Files -->
	<link href="/client_theme/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
	<!-- Bootstrap css -->
	<link href="/client_theme/css/style.css" rel="stylesheet" type="text/css" media="all" />
	<!-- Main css -->
	<link rel="stylesheet" href="/client_theme/css/fontawesome-all.css">
	<!-- Font-Awesome-Icons-CSS -->
	<link href="/client_theme/css/popuo-box.css" rel="stylesheet" type="text/css" media="all" />
	<!-- pop-up-box -->
	<link href="/client_theme/css/menu.css" rel="stylesheet" type="text/css" media="all" />
	<!-- menu style -->
	<!-- //Custom-Files -->

	<!-- web fonts -->
	<link href="/client_theme/css/lato.css" rel="stylesheet">
	<link href="/client_theme/css/opensan.css" rel="stylesheet">
	<!-- //web fonts -->
	<link rel="stylesheet" type="text/css" href="/admin_theme/css/toastr.css">
	<link rel="stylesheet" type="text/css" href="/client_theme/css/easy-responsive-tabs.css">
</head>
